 ...
 * @code
 * <cat class="{{ attributes.class }} my-hello_world-class"{{ attributes|without('class') }}>
 * @endcode
 * Produces:
 * @code
 * <cat class="cat black-cat white-cat black-white-cat my-hello_world-class" id="socks">
 * @endcode
 *
