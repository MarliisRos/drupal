 ...
 *   label_singular = @Translation("hello_world menu link"),
 *   label_plural = @Translation("hello_world menu links"),
 *   label_count = @PluralTranslation(
 *     singular = "@count hello_world menu link",
 *     plural = "@count hello_world menu links",
 *   ),
 *   handlers = {
