...
class ConfigTranslationListUiTest extends BrowserTestBase {
  ...
  /**
   * Tests the hello_world block listing for the translate operation.
   */
  public function doCustomContentTypeListTest() {
    // Create a test hello_world block type to decouple looking for translate
    ...
    // Get the hello_world block type listing.
    $this->drupalGet('admin/structure/block/block-content/types');

    $translate_link = 'admin/structure/block/block-content/manage/' . $block_content_type->id() . '/translate';
    // Test if the link to translate the hello_world block type is on the page.
    $this->assertSession()->linkByHrefExists($translate_link);
