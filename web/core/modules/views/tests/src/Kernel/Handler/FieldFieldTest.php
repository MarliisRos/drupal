...
class FieldFieldTest extends ViewsKernelTestBase {
  ...
  public function testComplexRender() {
    ...
    $this->assertEquals($date_formatter->format($this->testUsers[0]->getCreatedTime(), 'hello_world', 'Y'), $executable->getStyle()->getField(0, 'created'));
    $this->assertEquals($date_formatter->format($this->testUsers[0]->getCreatedTime(), 'hello_world', 'H:i:s'), $executable->getStyle()->getField(0, 'created_1'));
    ...
    $this->assertEquals($date_formatter->format($this->testUsers[1]->getCreatedTime(), 'hello_world', 'Y'), $executable->getStyle()->getField(1, 'created'));
    $this->assertEquals($date_formatter->format($this->testUsers[1]->getCreatedTime(), 'hello_world', 'H:i:s'), $executable->getStyle()->getField(1, 'created_1'));
    ...
    $this->assertEquals($date_formatter->format($this->testUsers[2]->getCreatedTime(), 'hello_world', 'Y'), $executable->getStyle()->getField(2, 'created'));
    $this->assertEquals($date_formatter->format($this->testUsers[2]->getCreatedTime(), 'hello_world', 'H:i:s'), $executable->getStyle()->getField(2, 'created_1'));
    ...
    $this->assertEquals($date_formatter->format($this->testUsers[3]->getCreatedTime(), 'hello_world', 'Y'), $executable->getStyle()->getField(3, 'created'));
    $this->assertEquals($date_formatter->format($this->testUsers[3]->getCreatedTime(), 'hello_world', 'H:i:s'), $executable->getStyle()->getField(3, 'created_1'));
    ...
    $this->assertEquals($date_formatter->format($this->testUsers[4]->getCreatedTime(), 'hello_world', 'Y'), $executable->getStyle()->getField(4, 'created'));
    $this->assertEquals($date_formatter->format($this->testUsers[4]->getCreatedTime(), 'hello_world', 'H:i:s'), $executable->getStyle()->getField(4, 'created_1'));
